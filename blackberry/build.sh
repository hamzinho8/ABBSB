...
javac -source 1.3 -target 1.3 -bootclasspath "$NET_RIM_API" -d build/classes $(find src -name "*.java")
...
java -jar "$RAPC_JAR" "import=$NET_RIM_API" codename=BBSmartBridge BBSmartBridge.rapc build/preverified.jar
